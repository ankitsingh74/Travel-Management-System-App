...
public class DeleteDetails extends JFrame  implements ActionListener {
    ...
    DeleteDetails(String username){
        ...
        lblnumber.setBounds(20,170,150,25);
        add(lblnumber);
        ...
        lblname.setBounds(20,230,150,25);
        add(lblname);
        ...
        lblgender.setBounds(20,290,150,25);
        add(lblgender);
        ...
        labelemail.setBounds(700,230,300,25);
        add(labelemail);
...
//duplicate of above image
        ...
        try {
            Conn c = new Conn();
            String query = "select * from customer where username = 'Ankit01'";
